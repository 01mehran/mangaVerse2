  ...
  return (
    ...
    >
      <svg
        ...
        className={`ease stroke-2 transition-all duration-150 ${isFavourite ? " stroke-danger fill-danger" : "stroke-bg hover:fill-danger/80 hover:stroke-danger/80 fill-none"}`}
      >
